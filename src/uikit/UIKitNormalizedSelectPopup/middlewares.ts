...
import type {NormalizedSelectRenderPopupProps} from '../../components/NormalizedSelect/types';

const BORDER_WIDTH = 1;

type MiddlewaresArgs = Pick<NormalizedSelectRenderPopupProps, 'width' | 'disablePortal'>;

const adjustBorderWidth = (width: number) => width - BORDER_WIDTH * 2;

const getPopupWidth = (width: NormalizedSelectRenderPopupProps['width'], controlWidth: number) => {
