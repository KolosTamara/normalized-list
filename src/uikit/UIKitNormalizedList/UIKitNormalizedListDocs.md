...
[`NormalizedList`](/docs/normalized-list-normalizedlist--docs) with default `renderItem` set to [`UIKitListItemView`](/docs/normalized-list-uikit-uikitlistitemview--docs) (list row themed for `@gravity-ui/uikit`).
