...
export interface TreeListItemViewContentProps extends ListItemViewContentType {
    selected?: boolean;
    disabled?: boolean;
    hasSelectionIcon: boolean;
}

export const TreeListItemViewContent = ({
    startSlot,
    subtitle,
    endSlot,
    disabled,
    ...
    renderExpandIcon: RenderExpandIcon = TreeListItemExpandIcon,
}: TreeListItemViewContentProps) => {
