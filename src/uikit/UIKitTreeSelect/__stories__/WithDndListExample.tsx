...
import {ListContainerView} from '../../../components/useList';
...
export interface WithDndListExampleProps extends Omit<
    UIKitTreeSelectProps<CustomDataType>,
    | 'value'
    | 'onUpdate'
    | 'items'
...
/**
 * UIKitTreeSelect with drag-and-drop reordering (custom renderItem/renderContainer).
 */
