...
import {TreeSelectClear} from '../TreeSelectClear';
...
/**
 * UIKit TreeSelect control matching Gravity UI Select control layout
 * with a dedicated BEM block and public UIKit SCSS mixins.
 */
export const TreeSelectControl = React.forwardRef(function TreeSelectControl<T>(
    {
        open,
        toggleOpen,
        clearValue,
    ...
    props: TreeSelectControlProps<T> & {ref?: React.Ref<HTMLButtonElement>},
) => React.ReactElement;
