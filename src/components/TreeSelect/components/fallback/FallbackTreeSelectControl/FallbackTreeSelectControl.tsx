...
import './FallbackTreeSelectControl.scss';

const b = block('fallback-tree-select-control');

export type FallbackTreeSelectControlProps = Omit<TreeSelectRenderControlProps<unknown>, 'ref'> & {
...
export const FallbackTreeSelectControl = React.forwardRef<
    HTMLButtonElement,
    FallbackTreeSelectControlProps
>(function FallbackTreeSelectControl(
    {
        open,
        toggleOpen,
        clearValue,
