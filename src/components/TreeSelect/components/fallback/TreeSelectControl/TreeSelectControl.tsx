...
export type TreeSelectControlProps = Omit<TreeSelectRenderControlProps<unknown>, 'ref'> & {
...
export const TreeSelectControl = React.forwardRef<HTMLButtonElement, TreeSelectControlProps>(
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    {showOptionsText && (
                        <span className={b('value')}>{selectedOptionsContent}</span>
                    )}
                </button>
                ...
                <span
                    className={b('chevron', {disabled: Boolean(disabled), open})}
                    aria-hidden="true"
                >
                    <ChevronIcon />
                </span>
