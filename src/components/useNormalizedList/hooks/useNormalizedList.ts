...
import type {InitialListParsedState, ListState, UseNormalizedListResult} from '../types';
...
interface UseNormalizedListProps<T>
 ...
 */
export const useNormalizedList = <T>({
    items,
    getItemId,
    ...
    controlledState,
}: UseNormalizedListProps<T>): UseNormalizedListResult<T> => {
