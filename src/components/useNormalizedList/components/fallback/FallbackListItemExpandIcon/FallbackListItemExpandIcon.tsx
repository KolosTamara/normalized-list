...
import type {ListItemExpandIconProps, ListItemExpandIconRenderProps} from '../../../types';

import './FallbackListItemExpandIcon.scss';

const b = block('fallback-list-item-expand-icon');

type IconDirection = 'top' | 'bottom' | 'left' | 'right';

export const FallbackListItemExpandIcon = ({
    expanded,
    behavior = 'action',
    disabled,
