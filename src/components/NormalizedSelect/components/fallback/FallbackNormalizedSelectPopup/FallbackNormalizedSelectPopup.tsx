...
import './FallbackNormalizedSelectPopup.scss';

const b = block('fallback-normalized-select-popup');
...
): Exclude<NormalizedSelectPopupPlacement, unknown[]> {
...
function getPopupStyle({
    ...
    placement: Exclude<NormalizedSelectPopupPlacement, unknown[]>;
...
export const FallbackNormalizedSelectPopup = ({
    open,
    onClose,
    anchorRef,
    children,
